...
//+PLUMEDOC COLVAR GRAPHMOLNODERIV
/*
This file is used for post-processing. It outputs the number of nodes that are classified by the ML model \
as specific classes. Several inputs need to be provided. CENTER corresponds to the position of nodes which \
...
PLUMED_REGISTER_ACTION(MolecularGraphGenerator,"GRAPHMOLNODERIV")
...
void MolecularGraphGenerator::registerKeywords( Keywords& keys ){
  ...
  keys.add("compulsory","KCUT","1","k-nearest neighbor for creating neighorlist"); // 
